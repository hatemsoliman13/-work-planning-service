 ...
 */
final class Version20220716050916 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE shift (id INT AUTO_INCREMENT NOT NULL, worker_id INT NOT NULL, shift_hours VARCHAR(50) NOT NULL, shift_date_time DATETIME NOT NULL, create_date_time DATETIME NOT NULL, update_date_time DATETIME NOT NULL, INDEX IDX_A50B3B456B20BA36 (worker_id), UNIQUE INDEX worker_shift_unique (worker_id, shift_date_time), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
